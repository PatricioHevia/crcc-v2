...
export class SidebarComponent {
  ...
  private allAdminBaseItems: { translationKey: string, icon: string, route: string[], name: string }[] = [
    ...
    { name: 'projects', translationKey: 'SIDEBAR.PROJECTS', icon: 'pi pi-briefcase', route: ['/admin/projects'] },
